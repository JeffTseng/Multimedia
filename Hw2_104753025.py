...
def Q4(WAVE_NOW_FILENAME):
    wave_data, time, params = wave_open(WAVE_NOW_FILENAME)
    echo_data = wave_data*0.6
    for i in xrange( 10000,len(wave_data[0]) ) :
        wave_data[0][i] = wave_data[0][i] + echo_data[0][i-10000]
        wave_data[1][i] = wave_data[1][i] + echo_data[1][i-10000]
...
def Q5(WAVE_NOW_FILENAME):
    wave_data, time, params = wave_open(WAVE_NOW_FILENAME)
    for i in xrange( 1,len(wave_data[0]) ) :
        wave_data[0][i] = wave_data[0][i] + wave_data[0][(len(wave_data))-i]
        wave_data[1][i] = wave_data[1][i] + wave_data[1][(len(wave_data))-i]
